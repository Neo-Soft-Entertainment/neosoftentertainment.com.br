(function () {
  const section = document.getElementById('neo-portfolio-3d');
  if (!section) return;

  const projects = window.NEO_PORTFOLIO_PROJECTS || [];
  if (!projects.length) return;

  const canvas = document.getElementById('neoPortfolioCanvas');
  ...
  const title = document.getElementById('neo-portfolio-title');
  const tagline = document.getElementById('neoPortfolioTagline');
  const description = document.getElementById('neoPortfolioDescription');
  const category = document.getElementById('neoPortfolioCategory');
  const status = document.getElementById('neoPortfolioStatus');
  const cta = document.getElementById('neoPortfolioCTA');
  const prevButton = document.getElementById('neoPortfolioPrev');
  const nextButton = document.getElementById('neoPortfolioNext');
  const currentCount = document.getElementById('neoPortfolioCurrent');
  const totalCount = document.getElementById('neoPortfolioTotal');
