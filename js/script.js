...
(function(){
  ...
  const translations = {
    en: {
      ...
      'games.apocrophia': 'GameJam-born roguelite FPS where you chase the zombie who stole your corgi across frantic runs.',
      'games.playApocrophia': 'Play Apocrophia →',
    ...
    pt: {
      ...
      'games.apocrophia': 'FPS roguelite criado em GameJam. Persiga o zumbi que levou seu cachorro em corridas caóticas.',
      'games.playApocrophia': 'Jogar Apocrophia →',
    ...
    es: {
      ...
      'games.apocrophia': 'FPS roguelite nacido en una GameJam. Persigue al zombi que robó a tu perro en partidas frenéticas.',
      'games.playApocrophia': 'Jugar Apocrophia →',
    ...
    zh: {
      ...
      'games.apocrophia': 'GameJam 诞生的节奏明快 Roguelite FPS，追击绑走你爱犬的僵尸，冲破混乱轮回。',
    ...
    ja: {
      ...
      'games.apocrophia': 'GameJam発のハイテンポなローグライトFPS。愛犬をさらったゾンビを追い詰める混沌ランを駆け抜けろ。',
