...
(function(){
  ...
  const translations = {
    en: {
      ...
      'games.apocrophia': 'Apocrophia is a fast-paced first-person shooter with roguelite mechanics. Chase down the zombie that kidnapped your dog by shredding hordes of infected creatures in a comedic, highly replayable adventure.',
    ...
    pt: {
      ...
      'games.apocrophia': 'Apocrophia é um FPS acelerado com mecânicas de roguelite. Persiga o zumbi que sequestrou seu cachorro enfrentando hordas de criaturas infectadas em uma aventura cômica e altamente rejogável.',
    ...
    es: {
      ...
      'games.apocrophia': 'Apocrophia es un shooter en primera persona vertiginoso con mecánicas roguelite. Persigue al zombi que secuestró a tu perro mientras aniquilas hordas de criaturas infectadas en una aventura cómica con alta rejugabilidad.',
    ...
    zh: {
      ...
      'games.apocrophia': '《Apocrophia》是一款节奏紧凑并融合 Roguelite 机制的第一人称射击游戏。追踪绑架你爱犬的僵尸，在这场充满喜剧色彩且高度可重复游玩的冒险中击碎成群感染怪物。',
    ...
    ja: {
      ...
      'games.apocrophia': '『Apocrophia』はローグライト要素を備えたハイテンポの一人称シューティング。ゾンビにさらわれた愛犬を取り戻すため、コミカルでリプレイ性の高い冒険の中、感染したクリーチャーの群れを撃ち抜こう。',
