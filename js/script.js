...
(function () {
  ...
  const translations = {
    en: {
      ...
      'games.ownSubtitle': 'Games, tools, and plugins we design, build, and ship ourselves. Drag to explore.',
      'games.clientsTitle': 'Client Work',
      'games.clientsSubtitle': 'Projects and tools we delivered for outside clients and partners.',
      ...
      'games.frontlinePlatform': 'Steam',
      'games.imobi': 'A mobile app for Android and iOS that simplifies property discovery through an interactive map — browse listings, filter by type, and find your next home with ease.',
      'games.imobiAndroid': 'Android',
      'games.imobiIos': 'iOS',
      'games.neolytics': 'A Steam viability analysis platform that helps teams validate project potential with clearer market signals, positioning, and decision support before production scales.',
      'games.neolyticsTag': 'Steam Analytics',
      'games.worldProcGen': 'A production plugin built to help teams author vast open worlds with faster iteration and reliable procedural workflows.',
      'games.neoLibrary': 'A focused Unreal Engine library that packages recurring studio needs into practical tools for game teams and technical designers.',
      'games.replicatedExplosion': 'A gameplay plugin designed for multiplayer Unreal projects that need reliable impact, VFX synchronization, and configurable blast behavior.',
      'games.advancedLoot': 'A plugin for Unreal teams that need flexible loot generation, replication support, and production-minded controls for item drops.',
      'games.openOnFab': 'Open on Fab',
      'games.vectorToys': 'Pricing hub built for Vector Toys that centralizes 3D printing cost models, materials, printer profiles, and margin-based pricing in one workflow.',
      'games.vectorToysTag': 'Completed Work',
      'games.vectorToysLink': 'Open project →',
      'games.fatum': 'A service project focused on spectator systems, grenade gameplay, replication fixes, and readable combat in fast arena modes.',
      'games.fatumTag': 'Service Project',
      ...
      'team.matheus.bio': 'Designs memorable gameplay experiences and drives marketing strategies that connect Neo Soft projects with players.',
    ...
    pt: {
      ...
      'games.title': 'Nossos Produtos',
      'games.ownSubtitle': 'Jogos, ferramentas e plugins que projetamos, construímos e lançamos por conta própria. Arraste para explorar.',
      'games.clientsTitle': 'Trabalhos para Terceiros',
      'games.clientsSubtitle': 'Projetos e ferramentas que entregamos para clientes e parceiros externos.',
      ...
      'games.frontlinePlatform': 'Steam',
      'games.imobi': 'Aplicativo mobile para Android e iOS que facilita a descoberta de imóveis em um mapa interativo — veja listagens, filtre por tipo e encontre seu próximo lar com facilidade.',
      'games.imobiAndroid': 'Android',
      'games.imobiIos': 'iOS',
      'games.neolytics': 'Plataforma de análise de viabilidade para projetos na Steam que ajuda equipes a validar potencial de mercado, posicionamento e tomada de decisão antes de escalar a produção.',
      'games.neolyticsTag': 'Análise Steam',
      'games.worldProcGen': 'Um plugin de produção criado para ajudar equipes a construir mundos abertos vastos com iteração mais rápida e fluxos procedurais confiáveis.',
      'games.neoLibrary': 'Uma biblioteca focada para Unreal Engine que reúne necessidades recorrentes de estúdio em ferramentas práticas para equipes de jogos e technical designers.',
      'games.replicatedExplosion': 'Um plugin de gameplay feito para projetos multiplayer em Unreal que precisam de impacto confiável, sincronização de VFX e comportamento de explosão configurável.',
      'games.advancedLoot': 'Um plugin para equipes Unreal que precisam de geração de loot flexível, suporte a replicação e controles voltados para produção na queda de itens.',
      'games.openOnFab': 'Abrir na Fab',
      'games.vectorToys': 'Central de precificação criada para a Vector Toys que reúne custos de impressão 3D, materiais, perfis de impressora e cálculo de margem em um fluxo único.',
      'games.vectorToysTag': 'Trabalho Entregue',
      'games.vectorToysLink': 'Abrir projeto →',
      'games.fatum': 'Um projeto de prestação de serviço focado em sistemas de espectador, gameplay de granadas, correção de replicação e combate legível em modos de arena rápidos.',
      'games.fatumTag': 'Projeto para Cliente',
      ...
      'team.matheus.bio': 'Cria experiências de gameplay memoráveis e lidera estratégias de marketing que conectam os projetos da Neo Soft aos jogadores.',
    ...
    es: {
      ...
      'games.title': 'Nuestros Productos',
      'games.ownSubtitle': 'Juegos, herramientas y plugins que diseñamos, construimos y lanzamos nosotros mismos. Arrastra para explorar.',
      'games.clientsTitle': 'Trabajos para Terceros',
      'games.clientsSubtitle': 'Proyectos y herramientas que entregamos para clientes y socios externos.',
      ...
      'games.frontlinePlatform': 'Steam',
      'games.imobi': 'App móvil para Android e iOS que simplifica el descubrimiento de propiedades a través de un mapa interactivo — explora listados, filtra por tipo y encuentra tu próximo hogar fácilmente.',
      'games.imobiAndroid': 'Android',
      'games.imobiIos': 'iOS',
      'games.neolytics': 'Plataforma de análisis de viabilidad para proyectos en Steam que ayuda a los equipos a validar el potencial del proyecto con señales de mercado, posicionamiento y apoyo para decisiones antes de escalar la producción.',
      'games.neolyticsTag': 'Análisis Steam',
      'games.worldProcGen': 'Un plugin de producción creado para ayudar a los equipos a construir mundos abiertos vastos con iteración más rápida y flujos procedurales confiables.',
      'games.neoLibrary': 'Una librería enfocada para Unreal Engine que reúne necesidades recurrentes del estudio en herramientas prácticas para equipos de juegos y diseñadores técnicos.',
      'games.replicatedExplosion': 'Un plugin de gameplay diseñado para proyectos multijugador en Unreal que necesitan impacto confiable, sincronización de VFX y comportamiento de explosión configurable.',
      'games.advancedLoot': 'Un plugin para equipos de Unreal que necesitan generación de botín flexible, soporte de replicación y controles orientados a producción para la caída de objetos.',
      'games.openOnFab': 'Abrir en Fab',
      'games.vectorToys': 'Centro de precios creado para Vector Toys que reúne costos de impresión 3D, materiales, perfiles de impresora y cálculo de margen en un solo flujo.',
      'games.vectorToysTag': 'Trabajo Entregado',
      'games.vectorToysLink': 'Abrir proyecto →',
      'games.fatum': 'Un proyecto de servicio enfocado en sistemas de espectador, gameplay de granadas, corrección de replicación y combate legible en modos de arena rápidos.',
      'games.fatumTag': 'Proyecto para Cliente',
      ...
      'team.matheus.bio': 'Diseña experiencias de juego memorables e impulsa estrategias de marketing que conectan los proyectos de Neo Soft con los jugadores.',
    ...
    zh: {
      ...
      'games.title': '我们的产品',
      'games.ownSubtitle': '由我们自主设计、开发并发布的游戏、工具与插件。拖动浏览。',
      'games.clientsTitle': '客户项目',
      'games.clientsSubtitle': '我们为外部客户与合作伙伴交付的项目与工具。',
      'games.frontline': '一款将真实感、张力与叙事融合的沉浸式战术射击——即将登陆 Steam，立即加入愿望单。',
      'games.frontlinePlatform': 'Steam',
      'games.imobi': '一款适用于 Android 和 iOS 的移动应用，通过交互式地图简化房产发现——浏览列表、按类型筛选，轻松找到下一个家。',
      'games.imobiAndroid': 'Android',
      'games.imobiIos': 'iOS',
      'games.neolytics': '一个面向 Steam 项目的可行性分析平台，在项目扩大制作前帮助团队更清晰地评估市场信号、定位与决策方向。',
      'games.neolyticsTag': 'Steam 分析',
      'games.worldProcGen': '一款生产级插件，帮助团队以更快的迭代速度和可靠的程序化流程构建广阔的开放世界。',
      'games.neoLibrary': '一个专注的 Unreal Engine 工具库，将工作室的常见需求打包成面向游戏团队和技术设计师的实用工具。',
      'games.replicatedExplosion': '一款为多人 Unreal 项目设计的玩法插件，提供可靠的命中反馈、VFX 同步和可配置的爆炸行为。',
      'games.advancedLoot': '一款面向 Unreal 团队的插件，提供灵活的战利品生成、复制支持以及面向生产环境的掉落物控制。',
      'games.openOnFab': '在 Fab 上打开',
      'games.vectorToys': '为 Vector Toys 打造的定价中心，把 3D 打印成本模型、材料、打印机配置和基于利润率的定价整合到一个流程中。',
      'games.vectorToysTag': '已交付项目',
      'games.vectorToysLink': '打开项目 →',
      'games.fatum': '一个服务项目，专注于观战系统、手雷玩法、复制同步修复以及快节奏竞技场模式下清晰可读的战斗体验。',
      'games.fatumTag': '客户项目',
      ...
      'team.matheus.bio': '打造令人难忘的玩法体验，并推动市场策略，让 Neo Soft 的项目与玩家建立连接。',
      'contact.title': '联系我们',
    ...
    ja: {
      ...
      'games.title': '私たちのプロダクト',
      'games.ownSubtitle': '私たちが自ら設計・開発・リリースしているゲーム、ツール、プラグイン。ドラッグしてご覧ください。',
      'games.clientsTitle': 'クライアントワーク',
      'games.clientsSubtitle': '外部のクライアントやパートナーのために制作・納品したプロジェクトやツール。',
      'games.frontline': 'リアリズム、緊張感、物語性を融合させた没入型タクティカルシューター — まもなく Steam で配信予定。ウィッシュリストに登録しよう。',
      'games.frontlinePlatform': 'Steam',
      'games.imobi': 'Android・iOS向けモバイルアプリで、インタラクティブマップを通じて物件探しをシンプルに — リストを閲覧し、種類で絞り込み、次の住まいを簡単に見つけよう。',
      'games.imobiAndroid': 'Android',
      'games.imobiIos': 'iOS',
      'games.neolytics': 'Steam向けプロジェクトの実現可能性を分析するプラットフォームで、市場シグナル、ポジショニング、意思決定材料を整理し、制作拡大前の判断を支援します。',
      'games.neolyticsTag': 'Steam分析',
      'games.worldProcGen': '広大なオープンワールドをより速いイテレーションと信頼性の高いプロシージャルワークフローで制作できるよう設計されたプロダクションプラグイン。',
      'games.neoLibrary': 'スタジオでよく必要になる機能を、ゲームチームやテクニカルデザイナー向けの実用的なツールにまとめた Unreal Engine 向けライブラリ。',
      'games.replicatedExplosion': '信頼性の高いヒット表現、VFX 同期、設定可能な爆発挙動を必要とするマルチプレイヤー Unreal プロジェクト向けのゲームプレイプラグイン。',
      'games.advancedLoot': '柔軟なルート生成、レプリケーション対応、プロダクション向けのドロップ制御を必要とする Unreal チーム向けプラグイン。',
      'games.openOnFab': 'Fabで開く',
      'games.vectorToys': 'Vector Toys向けに制作した価格計算ハブ。3Dプリントの原価モデル、素材、プリンタープロファイル、利益率ベースの価格計算をひとつの流れにまとめています。',
      'games.vectorToysTag': '制作実績',
      'games.vectorToysLink': 'プロジェクトを開く →',
      'games.fatum': '観戦システム、グレネードのゲームプレイ、レプリケーションの不具合修正、そして高速なアリーナモードで見やすい戦闘を実現することに焦点を当てた受託プロジェクト。',
      'games.fatumTag': 'クライアント案件',
      ...
      'team.matheus.bio': '印象に残るゲームプレイ体験を設計し、Neo Soft のプロジェクトをプレイヤーへ届けるマーケティング戦略を推進している。',
