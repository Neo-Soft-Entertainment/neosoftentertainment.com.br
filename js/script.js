...
(function(){
  ...
  const translations = {
    en: {
      ...
      'team.henrique.bio': 'Designs gameplay systems, levels, and player experiences that shape the heart of every Neo Soft adventure.',
    ...
    pt: {
      ...
      'team.henrique.bio': 'Projeta sistemas de jogo, níveis e experiências do jogador que moldam o coração de cada aventura da Neo Soft.',
    ...
    es: {
      ...
      'team.henrique.bio': 'Diseña sistemas de juego, niveles y experiencias de jugador que dan forma al corazón de cada aventura de Neo Soft.',
    ...
    zh: {
      ...
      'team.henrique.bio': '设计游戏系统、关卡与玩家体验，为每一次 Neo Soft 冒险注入核心灵魂。',
    ...
    ja: {
      ...
      'team.henrique.bio': 'ゲームシステムやレベル、プレイヤー体験を設計し、Neo Soft のあらゆる冒険の核を形作っている。',
