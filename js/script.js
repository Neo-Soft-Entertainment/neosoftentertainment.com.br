...
(function(){
  ...
  const translations = {
    en: {
      ...
      'games.banana': 'Um jogo coop onde todos os os jogadores sao macacos fugindo de um labortorio onde todos precisam correr e fugir enquanto fazem macacagns',
      ...
      'team.henrique.bio': 'Crafts narrative arcs, dialogue, and world-building that immerse players in the emotional core of our stories.',
    ...
    pt: {
      ...
      'team.henrique.bio': 'Cria arcos narrativos, diálogos e worldbuilding que mergulham jogadores no coração emocional das nossas histórias.',
    ...
    es: {
      ...
      'team.henrique.bio': 'Diseña arcos narrativos, diálogos y worldbuilding que sumergen a los jugadores en el corazón emocional de nuestras historias.',
    ...
    zh: {
      ...
      'team.henrique.bio': '塑造叙事弧线、对白与世界观，让玩家沉浸于故事的情感核心。',
    ...
    ja: {
      ...
      'team.henrique.bio': 'プレイヤーを物語の感情的な核へ没入させるため、ストーリーラインや会話、世界設定を緻密に作り上げている。',
